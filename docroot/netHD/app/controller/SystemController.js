...
Ext.define('New.controller.SystemController', {
	...
	views 	: ['BodyView','CanversView','DDBodyView','imageView','FormAddBulkDdView','FormAddCompanyView','FormAddEquipmentView','FormAddItemTypeView','FormAddPackageView','FormAddProjectsView','FormProjectDetailsView','FormUpdateCompany','FormUpdateEquipment','FormUpdateItemType','FormUpdatePackage','GridView','GridCompanyView','GridEquipmentsBulkView','GridEquipmentView','GridItemTypeView','GridPackageView','GridProjectsItemsView','GridProjectView','GridVersionMapView','MenuDivView','MenuBarView','SlideMenuView','SMenuHomeView'],
