...
Ext.define('New.controller.SystemController', {
	...
	views 	: ['BodyView','CanversView','DDBodyView','GenerateExcel','imageView','FormAddBulkDdView','FormAddCompanyView','FormAddEquipmentView','FormAddItemTypeView','FormAddPackageView','FormAddProjectsView','FormProjectDetailsView','FormUpdateCompany','FormUpdateEquipment','FormUpdateItemType','FormUpdatePackage','FormUpdateProjects','GridView','GridCompanyView','GridEquipmentsBulkView','GridEquipmentView','GridItemTypeView','GridPackageView','GridProjectsItemsView','GridProjectView','GridVersionMapView','MenuDivView','MenuBarView','SlideMenuView','SMenuEHomeView','SMenuHomeView'],
	stores 	: ['CompanyStore','CompanyStoreGrid','EquipmentsBulkStore','EquipmentsBulkCompStore','EquipmentsBulkStoreGrid','EquipmentStore','EquipmentStoreComp', 'EquipmentStoreGrid','GridStringStore','ItemTypeStore','ItemTypeStoreGrid','my','PackageStore','PackageStoreGrid','ProjectsStore','ProjectItemsStore1','ProjectItemsStoreResult','ProjectsStoreGrid','VersionMapStore','VersionMapStore2','VersionMapStoreGrid'],
